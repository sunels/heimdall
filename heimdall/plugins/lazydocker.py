...
class Plugin:
    name = "Lazydocker"
    description = "Lazydocker container yönetim aracını tam ekran çalıştır"
    ...
    def run_fullscreen(self, stdscr):
        ...
        try:
            ...
            print(f"\n  ⚠️  '{self.tool_command}' bulunamadı. Kurulum:")
            print("      curl https://raw.githubusercontent.com/jesseduffield/lazydocker/master/scripts/install_update_linux.sh | bash")
